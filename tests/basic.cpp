 ...
 */
TEST(knlite_test, equality_comparison)
{
    double x = 42.0;
 ...
 */
TEST(knlite_test, inequality_comparison)
{
    double x = 42.0;
    auto kx1 = kn::value{x}; // template parameter inference
    auto kx2 = kn::value<double>{x}; // no inference
 ...
 */
TEST(knlite_test, kahan_neumaier_float)
{
    // Test adding floats
 ...
 */
TEST(knlite_test, kahan_neumaier_double)
{
    // Test adding doubles
 ...
 */
TEST(knlite_test, kahan_neumaier_complex)
{
